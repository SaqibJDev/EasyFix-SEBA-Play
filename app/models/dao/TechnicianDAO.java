...
public class TechnicianDAO {
    ...
    public void add(Technician technician) {
        try {
            ...
            st.setString(2, technician.getTitle());
            st.setString(3, technician.getDescription());
            st.setString(4, technician.getImage());
            ...
            st.setString(8,
                    GsonUtil.createJson(technician.getContactInformation()));
            st.setString(9, GsonUtil.createJson(technician.getSchedule()));
            st.setString(10, GsonUtil.createJson(technician.getWorkingHours()));
            st.executeUpdate();
